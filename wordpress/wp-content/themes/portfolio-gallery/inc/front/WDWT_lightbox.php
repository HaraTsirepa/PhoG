...
class WDWT_Lightbox {
  ...
  public function __construct() {
    ...
    $this->wdwt_front = new Portfolio_gallery_front($wdwt_options);  
    ...
    $this->params['image_right_click'] = $this->wdwt_front->get_param('lbox_image_right_click') || ($this->wdwt_front->get_param('all_images_right_click'));
    ...
    /*colors*/
    $this->theme_row['lightbox_bg_color'] = $this->wdwt_front->get_param('[colors_active][colors][lightbox_bg_color][value]' , $meta_array = array(), $default = '#ffffff');
    ...
    $this->theme_row['lightbox_ctrl_cont_bg_color'] = $this->wdwt_front->get_param('[colors_active][colors][lightbox_ctrl_cont_bg_color][value]' , $meta_array = array(), $default = '#ffffff');
    ...
    $this->theme_row['lightbox_title_color'] = $this->wdwt_front->get_param('[colors_active][colors][lightbox_title_color][value]' , $meta_array = array(), $default = '#ffffff');
    ...
    $this->theme_row['lightbox_description_color'] = $this->wdwt_front->get_param('[colors_active][colors][lightbox_description_color][value]' , $meta_array = array(), $default = '#0a0a0a');
    $this->theme_row['lightbox_close_rl_btn_hover_color'] = $this->wdwt_front->get_param('[colors_active][colors][lightbox_close_rl_btn_hover_color][value]' , $meta_array = array(), $default = '#fdb813');
    ...
    $lightbox_description_font_weight = $this->wdwt_front->get_param('text_primary_weight');
    ...
    $this->theme_row['lightbox_description_font_weight'] = $lightbox_description_font_weight[0];
...
public function view() {
    ...
    <script>
      ...
      foreach ($image_rows as $key => $image_row) {
        ...
        wdwt_data["<?php echo $key; ?>"]["description"] = "<?php echo esc_attr(isset($descr_rows[$key]) ? str_replace(array('rn', 'n', 'r'), esc_html('<br />'), $descr_rows[$key]) : '' ); ?>" ;
    ...
    <?php
    if (!$image_id_exist) {
      echo '<div style="width:99%"><div class="error"><p><strong>' . __('The image has been deleted.', "portfolio-gallery") . '</strong></p></div></div>';
      die();
    }
    ?>
      ...
      <div class="wdwt_btn_container">
        <div class="wdwt_ctrl_btn_container">
          ...
          if ($enable_image_ctrl_btn) {
            ?>
          <i title="<?php esc_attr_e('Play', "portfolio-gallery"); ?>" class="wdwt_ctrl_btn wdwt_play_pause fa fa-play"></i>
          <?php
          }
          if ($enable_image_fullscreen) {
            if (!$open_with_fullscreen) {
          ?>
          <i title="<?php esc_attr_e('Maximize', "portfolio-gallery"); ?>" class="wdwt_ctrl_btn wdwt_resize-full fa fa-expand "></i>
          <?php
          }
          ?>
          <i title="<?php echo esc_attr_e('Fullscreen', "portfolio-gallery"); ?>" class="wdwt_ctrl_btn wdwt_fullscreen fa fa-arrows-alt"></i>
          <?php } 
          if ($popup_enable_info) { ?>
          <i title="<?php echo esc_attr_e('Show info', "portfolio-gallery"); ?>" class="wdwt_ctrl_btn wdwt_info fa fa-info"></i>
          <?php
          }
          if ($popup_enable_fullsize_image) {
            ?>
            <a id="wdwt_fullsize_image" href="<?php echo $current_image_url; ?>" target="_blank">
              <i title="<?php echo esc_attr_e('Open image in original size.', "portfolio-gallery"); ?>" class="wdwt_ctrl_btn fa fa-external-link"></i>
            </a>
            <?php
          }
          ?>
    ...
    <script>
      ...
      function wdwt_popup_resize() {
        ...
        if (typeof jQuery().fullscreen !== 'undefined' && jQuery.isFunction(jQuery().fullscreen) && !jQuery.fullscreen.isFullScreen()) {
          ...
          jQuery(".wdwt_resize-full").attr("class", "wdwt_ctrl_btn wdwt_resize-full fa fa-expand");
          jQuery(".wdwt_resize-full").attr("title", "<?php esc_attr_e('Maximize', "portfolio-gallery"); ?>");
          jQuery(".wdwt_fullscreen").attr("class", "wdwt_ctrl_btn wdwt_fullscreen fa fa-arrows-alt");
          jQuery(".wdwt_fullscreen").attr("title", "<?php esc_attr_e('Fullscreen', "portfolio-gallery"); ?>");
        }
      ...
      jQuery(document).ready(function () {
        ...
        if ($image_right_click) {
          ...
          jQuery(".wdwt_image_wrap").css('webkitTouchCallout','none');
          <?php
        }
        ?>
        ...
        jQuery(".wdwt_info").on(wdwt_click, function() {
          ...
          if (jQuery(".wdwt_image_info_container1").css("display") == 'none') {
            jQuery(".wdwt_image_info_container1").css("display", "table-cell");
            jQuery(".wdwt_info").attr("title", "<?php echo __('Hide info', "portfolio-gallery"); ?>");
          }
          else {
            jQuery(".wdwt_image_info_container1").css("display", "none");
            jQuery(".wdwt_info").attr("title", "<?php echo __('Show info', "portfolio-gallery"); ?>");
          }
        ...
        jQuery(".wdwt_resize-full").on(wdwt_click, function () {
          ...
          if (jQuery(".wdwt_resize-full").hasClass("fa-compress")) {
            ...
            jQuery(".wdwt_resize-full").attr("class", "wdwt_ctrl_btn wdwt_resize-full fa fa-expand");
            jQuery(".wdwt_resize-full").attr("title", "<?php echo __('Maximize', "portfolio-gallery"); ?>");
          }
          else {
            wdwt_popup_current_width = jQuery(window).width();
            wdwt_popup_current_height = jQuery(window).height();
            ...
            jQuery(".wdwt_resize-full").attr("class", "wdwt_ctrl_btn wdwt_resize-full fa fa-compress");
            jQuery(".wdwt_resize-full").attr("title", "<?php echo __('Restore', "portfolio-gallery"); ?>");
            jQuery(".wdwt_spider_popup_close").attr("class", "wdwt_ctrl_btn wdwt_spider_popup_close_fullscreen");
          }
        ...
        jQuery(".wdwt_fullscreen").on(wdwt_click, function () {
          ...
          function wdwt_exit_fullscreen() {
            ...
            jQuery("#wdwt_spider_popup_wrap").on("fscreenclose", function() {
              ...
              jQuery(".wdwt_resize-full").attr("title", "<?php echo __('Maximize', "portfolio-gallery"); ?>");
              jQuery(".wdwt_fullscreen").attr("class", "wdwt_ctrl_btn wdwt_fullscreen fa fa-arrows-alt");
              jQuery(".wdwt_fullscreen").attr("title", "<?php echo __('Fullscreen', "portfolio-gallery"); ?>");
              if ((jQuery("#wdwt_spider_popup_wrap").width() < jQuery(window).width()) && (jQuery("#wdwt_spider_popup_wrap").height() < jQuery(window).height())) {
                jQuery(".wdwt_spider_popup_close_fullscreen").attr("class", "wdwt_spider_popup_close");
              }
            });
          ...
          if (typeof jQuery().fullscreen !== 'undefined' && jQuery.isFunction(jQuery().fullscreen)) {
            if (jQuery.fullscreen.isFullScreen()) {
              ...
              jQuery("#wdwt_spider_popup_wrap").fullscreen();
                ...
                jQuery(".wdwt_fullscreen").attr("class", "wdwt_ctrl_btn wdwt_fullscreen fa fa-compress");
                jQuery(".wdwt_fullscreen").attr("title", "<?php esc_attr_e('Exit Fullscreen', "portfolio-gallery"); ?>");
                jQuery(".wdwt_spider_popup_close").attr("class", "wdwt_ctrl_btn wdwt_spider_popup_close_fullscreen");
        ...
        jQuery(".wdwt_play_pause, .wdwt_popup_image").on(wdwt_click, function () {
          if (jQuery(".wdwt_ctrl_btn").hasClass("fa-play")) {
            /* PLay.*/
            wdwt_play();
            jQuery(".wdwt_play_pause").attr("title", "<?php echo __('Pause', "portfolio-gallery"); ?>");
            ...
            window.clearInterval(wdwt_playInterval);
            jQuery(".wdwt_play_pause").attr("title", "<?php echo __('Play', "portfolio-gallery"); ?>");
